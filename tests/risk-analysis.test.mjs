...
import {
  gsiDemDecode, metersPerPixel, tileToLonLat, floodClassIndex,
  parseFloodRank, detectRiskProperties, estimateStoreys, deepFindFloodRank,
  createBuildingStats, accumulateBuilding,
  FLOOD_DEPTH_CLASSES, DEPTH_REPRESENTATIVE,
...
test('detectRiskProperties: 属性名の推定と想定最大優先', () => {
  const names = [
    'gml_id', 'bldg:measuredHeight', 'bldg:storeysAboveGround',
    '洪水浸水想定区域_計画規模_浸水ランク',
